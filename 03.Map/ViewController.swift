...
//  03.Map
//
//  Created by D7703_17 on 12/09/2017.
...
//            myMapView.addAnnotation(anno02)
            ...
            let a1 = information(title:"DIT", subtitle:"나의 꿈이 자라는 곳",coordinate :center)
            let a2 = information(title:"부산시민공원", subtitle: "부산시민들의 휴식처", coordinate : CLLocationCoordinate2D(latitude: 35.168444, longitude: 129.057832))
            
            myMapView.addAnnotation(a1)
            myMapView.addAnnotation(a2)
